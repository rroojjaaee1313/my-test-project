...
if submitted and model:
    with st.spinner(f"🕵️ 導師正在為 {c_agent} 進行實戰分析..."):
        try:
            ...
            請從專業房仲經營維度提供以下實戰建議：
            1.【市場分析與收泡建議】：目前此規格與開價，如何與屋主進行「收泡」議價或開發委託？
            2.【經營話術】：針對此案的優缺點，如何進行帶看回報，並向屋主議價？
            3.【客群描繪】：經紀人該優先聯絡哪類潛在客戶？如何包裝物件亮點吸引看屋？
            
            回應風格：專業、強幹、具備實戰感，禁止提供給一般消費者的選房建議。
            """
